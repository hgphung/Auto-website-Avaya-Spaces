...
${new_postname}       Da Nang University
*** Test Cases ***
TC_17 - Verify that User 2 login Avaya Space and update Post's name created by User 1   
    ...
    Log To Console    7. User 2 update Post's name created by User 1
